...
class ProductDetailWeb extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    <p id='top'><a href='#bottom'>Scroll to bottom</a></p>
          ...
          <tr>
            <td colspan="2"><img alt='Google' src='https://www.google.cn/images/branding/googlelogo/2x/googlelogo_color_92x30dp.png' /></td>
          </tr>
          </tbody>
          <tfoot>
          ...
          <img src='https://flutter.cn/images/flutter-mono-81x100.png' />
